                               ...
                               const std::vector<uint8_t> &zdoPayload)
{
    ...
    switch(clusterId)
    {
        case 0x0000: handleNetworkAddrReq(srcAddr, zdoPayload); break;
        case 0x0001: handleIeeeAddrReq(srcAddr, zdoPayload);    break;
        case 0x0002: handleNodeDescReq(srcAddr, zdoPayload);    break;
        case 0x0003: handlePowerDescReq(srcAddr, zdoPayload);   break;
        case 0x0004: handleSimpleDescReq(srcAddr, zdoPayload);  break;
        case 0x0005: handleActiveEPReq(srcAddr, zdoPayload);    break;
        case 0x0006: handleMatchDescReq(srcAddr, zdoPayload);   break;

        case 0x0021: handleBindReq(srcAddr, zdoPayload);        break;
        case 0x0022: handleUnbindReq(srcAddr, zdoPayload);      break;

        case 0x0036: handleMgmtPermitJoinReq(srcAddr, zdoPayload); break;
